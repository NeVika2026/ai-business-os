...
export const OSA_VOICE = {
  ...
  realWork: {
    clarifyIntro: 'Уточню пару моментов — так результат будет точнее.',
    clarifyCta: 'Собрать результат',
    workingHeadline: 'Сейчас работаю над этим',
    found: 'Готово.',
    versionReady: 'готово',
    improveCta: 'Улучшить',
    improveLoading: 'Улучшаю…',
    continueQuestion: 'Продолжим?',
    continueCta: 'Продолжить',
    changeTaskCta: 'Изменить задачу',
  },
  result: {
    presence: 'Готово.',
