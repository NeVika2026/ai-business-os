...
export const FACTORY_TOOLS: FactoryTool[] = [
  ...
  { id:'lip-sync', title:'Аватар + аудио', description:'Синхронизировать AI-персонажа с готовой аудиодорожкой.', status:'live', href:'/modules/create/avatar?mode=audio', mark:'◌' },
