...
export const VIRAL_PRESETS: ViralPreset[] = [
  ...
  {
    id: 'product-ad-factory',
    title: 'Product Ad Factory',
    description: '1–10 фото товара → готовый cinematic рекламный ролик.',
    category: 'video',
    status: 'ready',
    badge: 'RECIPE',
    href: '/modules/create/campaign?kind=product_ad',
  },
  {
    id: 'campaign-images',
    title: 'Campaign Images',
    description: 'Фото товара → серия согласованных рекламных визуалов.',
    category: 'visual',
    status: 'ready',
    badge: 'RECIPE',
    href: '/modules/create/campaign?kind=product_campaign',
  },
  {
    id: 'ad-localization',
    title: 'Локализация рекламы',
    description: 'Сохранить дизайн креатива и адаптировать текст под другой язык.',
    category: 'business',
    status: 'ready',
    badge: 'GLOBAL',
    href: '/modules/create/campaign?kind=ad_localization',
  },
  {
    id: 'multi-shot-video',
    title: 'Multi-shot ролик',
    description: 'Несколько управляемых сцен → один связный рекламный ролик.',
    category: 'video',
    status: 'ready',
    badge: 'CINEMA',
    href: '/modules/create/campaign?kind=multi_shot',
  },
  {
    id: 'product-video',
