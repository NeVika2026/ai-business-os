...
import {
  ...
  runwayVideoExtendHandler,
  runwayMotionTransferHandler,
...
const PRODUCTION_HANDLERS: Record<string, BaseToolHandler> = {
  ...
  'media.avatar.create': runwayAvatarCreateHandler,
  ...
  'media.video.extend': runwayVideoExtendHandler,
  'media.motion_transfer.generate': runwayMotionTransferHandler,
