    ...
    <main className="relative mx-auto w-full max-w-[1320px] overflow-hidden pb-16 text-[#f7f2e8]">
      ...
      <section className="mt-5 rounded-[24px] border border-white/[0.07] bg-white/[0.02] p-5">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-white/62">
          Telegram, ВКонтакте, YouTube, Instagram Reels, TikTok и MAX публикуют напрямую после подключения доступа. Telegram отправляет фото, видео и аудио; ВКонтакте — текст и изображение; YouTube, Instagram Reels и TikTok — выбранный видеофайл. Прямая отправка доступна владельцу и администраторам организации. Дзен получает готовую версию на копирование и скачивание Markdown — без имитации прямого API.
        </p>
      </section>
    </main>
  );
